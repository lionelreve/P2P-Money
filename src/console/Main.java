...
import util.console.CommandFactory;
import util.console.ConsoleThread;
import util.console.ExecuteMacro;
import util.console.MemoryOutputStream;
import util.console.ShowOutputCommand;

// import de.uniba.wiai.lspi.chord.com.local.Registry;
import console.command.*;
// import de.uniba.wiai.lspi.chord.data.URL;
// import de.uniba.wiai.lspi.chord.service.Chord;
//XXX import de.uniba.wiai.lspi.chord.service.PropertiesLoader;
...
public class Main {
	...
	public static void main(String[] args) throws Throwable {
		...
		//XXX PropertiesLoader.loadPropertyFile();
		...
		*/
		 ...
		 */
		Object toCommand = null ; //XXX Registry.getRegistryInstance();

		CommandFactory factory = new CommandFactory(new Object[] { toCommand,
				//RemoteChordNetworkAccess.getUniqueInstance() 
				}, System.out,
				commandMapping);
